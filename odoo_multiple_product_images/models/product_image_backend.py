        ...
        for backend_image in self:
            ...
            if backend_image.image:
                try:
                    ...
                    decoded_image = base64.b64decode(backend_image.image)
                    # Verificar el tamaño de la imagen decodificada
                    backend_image.raw_image_size = len(decoded_image) // 1000
                except (TypeError, ValueError):
                    # Manejar errores de decodificación de base64
                    backend_image.raw_image_size = 0
            else:
                backend_image.raw_image_size = 0
